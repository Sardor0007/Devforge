...
urlpatterns = [
    ...
    path('super-admin/toggle-studio/<str:studio_id>/', accounts_dash.super_admin_toggle_studio, name='super_admin_toggle_studio'),
    path('super-admin/set-all-studios/<str:action>/', accounts_dash.super_admin_set_all_studios, name='super_admin_set_all_studios'),

...
urlpatterns = [
    ...
    path('projects/<int:pk>/export/', views.project_download_view, name='project_export'),
    path('projects/<int:pk>/files/<int:file_pk>/export/', views.project_export_file_view, name='project_export_file'),
